        ...
        prepared.append(
            {
                ...
                "date_added": _parse_date(row.get("date_added")),
                "url": row.get("url"),
                "status": row.get("applicant_status"),
                "term": row.get("semester_year_start"),
                "us_or_international": row.get("citizenship"),
                "gpa": _parse_float(row.get("gpa"), r"([0-4]\.\d{1,2})"),
                "gre": _parse_float(row.get("gre"), r"(\d{3})"),
                "gre_v": _parse_float(row.get("gre_v"), r"(\d{2,3})"),
                "gre_aw": _parse_float(row.get("gre_aw"), r"([0-6]\.?\d?)"),
